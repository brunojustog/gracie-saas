...
const slotSchema = z.object({
  ...
  // v1.2-AS: fim (HH:MM) + tatame/local — opcionais.
  endTime: z.string().regex(/^\d{2}:\d{2}$/).nullable().optional().or(z.literal("").transform(() => null)),
  local: z.string().max(60).nullable().optional().or(z.literal("").transform(() => null)),
